...
class GeneralNewsFragment : Fragment() {
    private var generalNews: ArrayList<NewsPost> = arrayListOf()
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_general_news, container, false)

        NewsApiManager.getTopHeadlinesNews(NewsApiManager.GENERAL) { wasSuccessful, newsPosts ->
            if (wasSuccessful) {
                generalNews = newsPosts!!
        ...
        val recyclerView = root.findViewById<RecyclerView>(R.id.recyclerViewGeneralNews)
    ...
    inner class NewsAdapter() : RecyclerView.Adapter<NewsAdapter.PostViewHolder>() {
        ...
        override fun onBindViewHolder(holder: PostViewHolder, position: Int) {
            val curNews = generalNews[position]
            ...
            holder.layoutRowNews.setOnClickListener {
                ...
                intent.putExtra(NewsWebView.EXTRA_NEWS, generalNews[position].toJson().toString())
        ...
        override fun getItemCount() = generalNews.size
